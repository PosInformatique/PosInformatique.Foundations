...
[![NuGet version](https://img.shields.io/nuget/v/PosInformatique.Foundations.People.AwesomeAssertions)](https://www.nuget.org/packages/PosInformatique.Foundations.People.AwesomeAssertions/)
[![NuGet downloads](https://img.shields.io/nuget/dt/PosInformatique.Foundations.People.AwesomeAssertions)](https://www.nuget.org/packages/PosInformatique.Foundations.People.AwesomeAssertions/)
...
- Calling `Should()` from [AwesomeAssertions](https://awesomeassertions.org/) on such types leads to a compile-time ambiguity:
...
```powershell
dotnet add package PosInformatique.Foundations.People.AwesomeAssertions
```
