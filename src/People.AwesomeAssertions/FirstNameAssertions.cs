...
namespace PosInformatique.Foundations.People
{
    ...
    public sealed class FirstNameAssertions : ObjectAssertions<FirstName, FirstNameAssertions>
    {
        ...
        internal FirstNameAssertions(FirstName value, AssertionChain assertionChain)
        ...
        {
            var assertion = new StringAssertions(this.Subject.ToString(), this.assertionChain);
